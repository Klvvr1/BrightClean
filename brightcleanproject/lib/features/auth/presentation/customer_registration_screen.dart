...
class _CustomerRegistrationScreenState extends State<CustomerRegistrationScreen> {
  ...
  Future<void> _submitForm() async {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        if (kIsWeb) {
          debugPrint("Web mode detected: Geocoding bypassed. Saving raw coordinates: $_selectedCoordinates");
        }
  ...
  String? _validatePassword(String? value) {
    ...
    if (!RegExp(r'[a-zA-Z\u0600-\u06FF]').hasMatch(value) || !RegExp(r'[0-9]').hasMatch(value)) {
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(color: _selectedAddress == null ? Colors.grey.shade300 : AppColors.primary),
                      ...
                      child: Column(
                        ...
                        children: [
                          Icon(
                            Icons.map, 
                            size: 40, 
                            color: _selectedAddress == null ? Colors.grey : AppColors.primary
                          ),
