...
class AgentRegistrationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('تسجيل مغسلة جديدة')),
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            const CustomTextField(hintText: 'اسم المغسلة'),
            const SizedBox(height: 16),
            const CustomTextField(hintText: 'الخدمات المقدمة (مفصولة بفاصلة)'),
            const SizedBox(height: 16),
            ...
            const SizedBox(height: 16),
            _buildFileUploadPlaceholder('رفع السجل التجاري'),
              ...
              child: const Center(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 8),
                    Text('حدد موقع اللمغسلة على الخريطة'),
                  ],
                ),
              ),
            ),
