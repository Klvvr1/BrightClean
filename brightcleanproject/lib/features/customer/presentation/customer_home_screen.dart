              ...
              SizedBox(
                ...
                child: ScrollConfiguration(
                  ...
                  child: ListView(
                    ...
                    padding: const EdgeInsets.symmetric(horizontal: 16),
                    children: [
                      _buildOfferCard('خصم 20%', 'على غسيل السجاد والمفروشات',
                          AppColors.primary),
                      _buildOfferCard('غسيل مجاني',
                          'اغسل 5 قمصان والسادس مجاناً', AppColors.tertiary),
                      _buildOfferCard('باقة التوفير',
                          'خصم خاص للاشتراكات الشهرية', Colors.teal),
                    ],
                  ),
                ),
              ),
              ...
              SizedBox(
                ...
                child: ScrollConfiguration(
                  ...
                  child: ListView(
                    ...
                    padding: const EdgeInsets.symmetric(horizontal: 16),
                    children: [
                      _buildCategoryCard(context, 'الملابس', Icons.checkroom,
                          AppColors.primary),
                      _buildCategoryCard(context, 'السجاد والمفروشات',
                          Icons.dataset, AppColors.secondary),
                      _buildCategoryCard(context, 'السيارات',
                          Icons.directions_car, AppColors.tertiary),
                      _buildCategoryCard(context, 'تنظيف المكيفات',
                          Icons.ac_unit, Colors.teal),
                      _buildCategoryCard(context, 'عاملات النظافة',
                          Icons.cleaning_services, Colors.pink),
                      _buildCategoryCard(context, 'تنظيف الخزانات',
                          Icons.water_drop, Colors.blueAccent),
                      _buildCategoryCard(context, 'غسيل الألواح الشمسية',
                          Icons.solar_power, Colors.orange),
                    ],
                  ),
                ),
              ),
