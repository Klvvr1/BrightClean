...
class _AgentDashboardScreenState extends State<AgentDashboardScreen> {
  ...
  List<AgentOrderModel> get _currentOrders => _allOrders
      .where((o) =>
          o.laundryType == widget.laundryType &&
  ...
  Widget _buildServicesSection() {
    ...
    switch (widget.laundryType) {
      case LaundryType.clothes:
        services = isArabic
            ? ['غسيل', 'كوي', 'تنظيف جاف', 'غسيل مستعجل']
            : ['Wash', 'Iron', 'Dry Clean', 'Express'];
        break;
      case LaundryType.carsBikes:
        services = isArabic
            ? ['غسيل خارجي', 'غسيل داخلي', 'تلميع', 'غسيل مكينة']
            : ['Exterior', 'Interior', 'Polishing', 'Engine'];
        break;
      case LaundryType.carpets:
        services = isArabic
            ? ['غسيل عميق', 'تعطير', 'إزالة بقع صعبه']
            : ['Deep Wash', 'Scenting', 'Stain Removal'];
        break;
      case LaundryType.ac:
        services = isArabic
            ? ['تنظيف فلاتر', 'غسيل الوحدة الخارجية', 'تعبئة فريون']
            : ['Filters', 'Outdoor Unit', 'Gas Refill'];
        break;
      case LaundryType.tanks:
        services = isArabic
            ? ['تفريغ وتنظيف', 'تعقيم الأسطح', 'عزل وتسكير']
            : ['Emptying', 'Sterilization', 'Insulation'];
        break;
      case LaundryType.solarPanels:
        services = isArabic
            ? ['تنظيف جاف', 'غسيل بالمواصفات', 'فحص كفاءة']
            : ['Dry Clean', 'Spec Wash', 'Efficiency Check'];
        break;
    }
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
