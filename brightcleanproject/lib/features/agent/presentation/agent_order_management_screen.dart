...
class _AgentOrderManagementScreenState
    ...
    return await showDialog<bool>(
          ...
          builder: (context) => AlertDialog(
            ...
            content: Text(isArabic
                ? 'لديك تغييرات لم تقم بحفظها، هل أنت متأكد من رغبتك في الخروج؟'
            ...
            actions: [
              ...
              ElevatedButton(
                ...
                child:
                    Text(isArabic ? 'الخروج بدون حفظ' : 'Leave without saving'),
              ),
            ],
          ),
        ) ??
  ...
  Future<void> _openPaymentProof(String proofUrl, bool isArabic) async {
    ...
    // Only include authenticated headers if the URL belongs to our trusted API origin
    final trustedApiHost = Uri.parse(BaseApiClient.defaultBaseUrl).host;
    final headers = (uri.host == trustedApiHost)
        ? await BaseApiClient().getAuthenticatedHeaders()
        : <String, String>{};
          ...
          return PopScope(
            ...
            onPopInvokedWithResult: (didPop, result) async {
              ...
              final bool shouldPop =
                  await _showUnsavedChangesDialog(context, isArabic);
            ...
            child: Scaffold(
              ...
              appBar: AppBar(
                ...
                title: Text(isArabic
                    ? 'إدارة الطلب #${widget.orderId}'
                    : 'Manage Order #${widget.orderId}'),
                elevation: 0,
                actions: const [
                  AgentAppBarActions(),
                ],
        ...
        children: [
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(isArabic ? item.itemName : _translateItem(item.itemName),
                    style: const TextStyle(
                ...
                Text(
                    isArabic
                        ? item.serviceType
                        : _translateService(item.serviceType),
                    style: TextStyle(
                        fontSize: 12,
                        color: isDark
